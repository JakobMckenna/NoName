...
function Header({ projectData, userID, owner }: { projectData: any, userID: number | null, owner: number | null }) {
    return (
        <div className=" flex flex-col justify-start    prose">

            <div className="flex flex-row items-baseline ">
                <h1 className="text-4xl uppercase mb-2">{projectData ? `${projectData.name} PROJECT` : (<div className="skeleton h-9 w-72"></div>)} </h1>
                {
...
export default function Project() {
    ...
    return (
        <>
            ...
            <main className="container mx-auto flex flex-col items-center justify-center  mb-10    ">
                <BackPage link="/home" name="Back To Home Page" />
                <Header projectData={projectData} userID={userID} owner={owner} />
                <div className=" grid grid-cols-1 md:grid-cols-2 justify-items-center gap-y-8 gap-x-5  ">
