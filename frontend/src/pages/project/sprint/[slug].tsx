...
function Sprints({ sprints, changeSelected }: any) {
    // console.log(sprints)
...
function MilestoneHero({ sprints, changeSelected }: any) {
    return (
        <div className="flex  flex-col justify-evenly md:flex-row ">
            ...
            <Sprints sprints={sprints} changeSelected={changeSelected} />
        </div>
    )
}
...
return (
    <div>
        ...
        <main className="container mx-auto">
            ...
            <div >
                <MilestoneHero sprints={sprints} changeSelected={changeSelected} />
            </div>
        </main>
